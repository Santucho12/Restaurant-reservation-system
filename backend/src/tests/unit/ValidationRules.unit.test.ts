...
describe('ValidationRules', () => {
  ...
  describe('TurnoRule', () => {
    it('debería validar correctamente horario de almuerzo (13:00)', async () => {
    ...
    it('debería validar correctamente horario de cena (21:00)', async () => {
      const rule = new TurnoRule();
      const datos = {
    ...
    it('debería lanzar error fuera de horario permitido (17:00)', async () => {
      const rule = new TurnoRule();
      const datos = {
